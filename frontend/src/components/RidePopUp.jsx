...
const RidePopUp = (props) => {
    return (
        <div>
            ...
            <h3 className='text-2xl font-semibold mb-5'>New Borrower Available!</h3>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-5 w-full '>
                    ...
                    }} className=' bg-green-600 w-full text-white font-semibold p-2 px-10 rounded-lg'>Rent</button>
