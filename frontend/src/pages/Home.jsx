...
const Home = () => {
    ...
    return (
      ...
      {!panelOpen && <header className="absolute top-0 inset-x-0 z-20 flex items-center justify-between px-6 py-4 bg-white bg-opacity-80 backdrop-blur-md">
        <img
          className="w-20 h-20 cursor-pointer"
          src="/ChatGPT%20Image%20May%2018,%202025,%2010_07_19%20PM.png"
          alt="RentWheelz Logo"
        />
        <button
